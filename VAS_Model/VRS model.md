...
<br>
CRS模式中所求得的效率值稱為**總體效率值(overall efficiency, OE)**，而VRS模式所得的效率值為**技術效率(technical efficiency, TE)**，藉由這兩者之比較可得到**規模效率(scale efficiency, SE)**，因此得出以下公式:<br>
<br>
**<p align="center">E<sub>r</sup></sub><sup>CRS</sup></sub>(總體效率值, OE) = E<sub>r</sup></sub><sup>VRS</sup></sub>(技術效率, TE) X 規模效率(SE)</p>** 
